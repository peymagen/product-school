    ...
    <nav className={styles.navbar}>
      ...
      <ul className={styles.menu}>
        <li className={styles.menuItem}>
          Features <MdKeyboardArrowDown className="w-4 h-4" />
        </li>
        <li className={styles.menuItem}>
          Products <MdKeyboardArrowDown className="w-4 h-4" />
        </li>
        <li className={styles.menuItem}>
          Resources <MdKeyboardArrowDown className="w-4 h-4" />
        </li>
        <li className={styles.menuItem}>
          Pricing <MdKeyboardArrowDown className="w-4 h-4" />
        </li>
        <li>
